...
export function useChatAgent() {
    const { provider, apiKey, model, cs_api_key, cs_delivery_token, content_type, } = useChatConfig();
    ...
    const sendMessage = useCallback(async (message) => {
        ...
        try {
            ...
            if (!res.body) {
                ...
                const errMsg = { id: String(Date.now() + 1), role: 'assistant', text: `Error: ${txt}` };
...
//# sourceMappingURL=useChatAgent.js.map