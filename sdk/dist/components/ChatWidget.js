...
export default function ChatWidget({ title = "Sendbird Bot", status = "We’re online..." }) {
    const { provider, apiKey, model, cs_api_key, cs_delivery_token, content_type, theme } = useChatConfig();
